#code is from https://github.com/Nikitae57/simple_image_download/blob/master/simple_image_download/simple_image_download.py
#main package cannot be used because download folder is not customizable
#linked branch fixed that
#Issue
#https://github.com/RiddlerQ/simple_image_download/issues/4
#Is fixed here by Sascha Rolinger
import os
import time
import urllib
import requests
...
response.download('bear', 100, main_directory="C:/projekte/simple")

print(response.urls('bear', 100))